...
figure;
plot(1:50, J1(1:50), '-b', 'LineWidth', 2); % plots the first fifty iterations, and the cost functions
hold on;
...
x_test = [1650 3]; 
x_norm = bsxfun(@rdivide,bsxfun(@minus, x_test, mu),sigma);
x_norm = [1 x_norm];
price = x_norm * theta2; % You should change this
